export default [
  {
    ...
    image: "../public/images/humahuaca.jpg",
    pais: "Argentina",
  ...
  },
  {
    ...
    title: "Viena",
    description:
      "Ubicado en el centro de Europa. Viena (en alemán: Wien, pronunciado /viːn/ es una ciudad austriaca situada a orillas del Danubio, en el valle de los Bosques de Viena, al pie de las primeras estribaciones de los Alpes. Es la capital federal y ciudad principal del país, además de uno de sus nueve estados federados (Bundesland Wien).",
    image: "./public/images/viena.jpg",
    pais: "Austria",
    location: "https://goo.gl/maps/L4P7jgse3TCFeeXF7",
  },
  {
    id: 3,
    title: "Porto Alegre",
